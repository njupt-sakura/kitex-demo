...
func (p *GetItemStockRes) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetItemStockRes[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *GetItemStockRes) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *GetItemStockRes) FastReadField255(buf []byte) (int, error) {
	offset := 0
...
func (p *GetItemStockRes) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *GetItemStockRes) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
...
func (p *GetItemStockRes) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
		l += p.field255Length()
...
func (p *GetItemStockRes) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 1)
...
func (p *GetItemStockRes) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *GetItemStockRes) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.I64Length()
	return l
...
func (p *GetItemStockRes) field255Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.BaseRes.BLength()
	return l
