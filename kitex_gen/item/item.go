...
func NewGetItemRes() *GetItemRes {
	return &GetItemRes{}
}

func (p *GetItemRes) InitDefault() {
}

var GetItemRes_Item_DEFAULT *Item

func (p *GetItemRes) GetItem() (v *Item) {
	if !p.IsSetItem() {
		return GetItemRes_Item_DEFAULT
	}
	return p.Item
}

var GetItemRes_BaseRes_DEFAULT *base.BaseRes

func (p *GetItemRes) GetBaseRes() (v *base.BaseRes) {
	if !p.IsSetBaseRes() {
		return GetItemRes_BaseRes_DEFAULT
	}
	return p.BaseRes
}
func (p *GetItemRes) SetItem(val *Item) {
	p.Item = val
}
func (p *GetItemRes) SetBaseRes(val *base.BaseRes) {
	p.BaseRes = val
}

func (p *GetItemRes) IsSetItem() bool {
	return p.Item != nil
}

func (p *GetItemRes) IsSetBaseRes() bool {
	return p.BaseRes != nil
}

func (p *GetItemRes) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("GetItemRes(%+v)", *p)
}

var fieldIDToName_GetItemRes = map[int16]string{
	1:   "item",
	255: "baseRes",
}

type ItemService interface {
	GetItem(ctx context.Context, req *GetItemReq) (r *GetItemRes, err error)
}
...
type ItemServiceGetItemResult struct {
	Success *GetItemRes `thrift:"success,0,optional" frugal:"0,optional,GetItemRes" json:"success,omitempty"`
}
...
var ItemServiceGetItemResult_Success_DEFAULT *GetItemRes

func (p *ItemServiceGetItemResult) GetSuccess() (v *GetItemRes) {
	if !p.IsSetSuccess() {
