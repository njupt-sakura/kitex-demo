...
func (p *GetItemRes) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_GetItemRes[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *GetItemRes) FastReadField1(buf []byte) (int, error) {
	offset := 0
	_field := NewItem()
...
func (p *GetItemRes) FastReadField255(buf []byte) (int, error) {
	offset := 0
...
func (p *GetItemRes) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *GetItemRes) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
...
func (p *GetItemRes) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *GetItemRes) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *GetItemRes) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Item.BLength()
	return l
...
func (p *GetItemRes) field255Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.BaseRes.BLength()
	return l
